...
public class ConcurrentHashMapPerformanceController {
    ...
    public static void main(String[] args) throws InterruptedException {
        ConcurrentHashMapPerformanceController concurrentHashMapPerformanceController = new ConcurrentHashMapPerformanceController();
        concurrentHashMapPerformanceController.good();
    }
    @GetMapping("good")
